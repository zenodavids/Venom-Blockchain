...
import tokenRootAbi from '../utils/abis/TokenRoot.abi.json';
import tokenWalletAbi from '../utils/abis/TokenWallet.abi.json';
...
// type Props = {
//   venomConnect: Promise<VenomConnect>;
// };

const Main = ({ venomConnect }: Props) => {
  ...
  // Any interaction with venom-wallet (address fetching is included) needs to be authenticated
