...
async function main() {
  ...
  const initialSupplyTo = new Address("0:1db7eb2d73dc04ba37139c7499f7edec47dd2e12e99de925ace86ab9056b6d0e");
  // Address of token owner (write your own)
  const rootOwner = new Address("0:1db7eb2d73dc04ba37139c7499f7edec47dd2e12e99de925ace86ab9056b6d0e");
  // Name of the token
